...
<head>
    ...
    <title>Appointment Calendar | Clinic Management System</title>
    ...
    <style>
        ...
        .calendar-card { background: #fff; border-radius: 16px; padding: 24px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); }
...
<body>
    <div class="sidebar">
        ...
        <div class="nav flex-column mt-3">
            ...
            <a href="${pageContext.request.contextPath}/receptionist/calendar" class="nav-link-item active"><i class="fas fa-calendar-alt"></i> <span>Calendar</span></a>
    ...
    <div class="main-content">
        <div class="calendar-card">
            <h5 class="fw-bold mb-4">Appointment Schedule</h5>
            <div id="calendar"></div>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: '${pageContext.request.contextPath}/receptionist/appointments/all',
