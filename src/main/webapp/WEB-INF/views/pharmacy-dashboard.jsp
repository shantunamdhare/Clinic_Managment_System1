...
<body>
    <div class="dashboard-container">
        <div class="header">
            <div>
                <h1 style="font-size: 24px; font-weight: 800; color: #fff;">&#x1F48A; Pharmacy Panel</h1>
        ...
        <div style="margin-top: 30px; background: rgba(255,255,255,0.02); padding: 40px; border-radius: 20px; text-align: center; border: 1px solid rgba(255,255,255,0.05);">
            ...
            <p style="color: #64748b; margin-top: 10px;">Manage stock levels, fulfill prescriptions, and handle pharmacy billing.</p>
        </div>
    </div>
</body>
</html>
